...
if(isset($_POST['ad_id_kkw'])){
    ...
    $checkAdminQuery = "SELECT * FROM `tiger_login` where `id` = '{$_POST['ad_id_kkw']}'";
    ...
    if(mysqli_num_rows($db_content) != 0) {
        ...
        <body>
                ...
                <section>
                    ...
                    <form class="ad_serarchbox_ksg" action="./admin.php" method="post">
                    ...
                    <form class="ad_form_ksg" id="ad_form_ksg" action="./admin.php" method="post">
                        ...
                        <input type="text" class="ad_name_ksg" value="{$test_info['name']}" name="name">                
