<?php
    ...
    if(isset($_POST['id'])){
        ...
        $pw_md = md5($_POST['pw']);
        $add_query = "INSERT `tiger_login` SET `id` = '{$_POST['id']}', `pwd`='{$pw_md}',`name`= '{$_POST['name']}', `birth`='{$_POST['birth']}', `tel`='{$_POST['phone']}', `name_en`='{$_POST['name_en']}', `sex`='{$_POST['sex']}', `country`='{$_POST['from']}', `address`='{$_POST['address']}', `mail`='{$_POST['email']}'";
